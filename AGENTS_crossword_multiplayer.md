...
- **Хаб** — сам бот, рассылающий все события синхронно в личные чаты игроков. Общий групповой чат больше не используется: объявления ходов, подсказки, таймеры и финальные таблицы приходят каждому участнику напрямую.
